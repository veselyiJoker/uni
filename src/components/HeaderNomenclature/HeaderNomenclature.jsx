        ...
        <StyledHeaderNomenclature>
            ...
            <List>
                <li>
                    ...
                    <SubList>
                        <li>
                            <NomenclatureLink to='/nomenclature?type=medicines'>
                                Лекарственные средства
                            </NomenclatureLink>
                        </li>
                        <li>
                            <NomenclatureLink to='/nomenclature?type=medical-products'>
                                Изделия медицинского назначения
                            </NomenclatureLink>
                        </li>
                        <li>
                            <NomenclatureLink to='/nomenclature?type=biologically-active-additives'>
